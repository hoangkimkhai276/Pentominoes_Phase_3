...
public class KnapsackGroup extends SmartGroup {
    ...
    static {
        ...
        ParcelCore p9 = Parcels.A.copy();
        p1.moveParcel(new Point3D(0, 0, 0));
        ...
        p9.moveParcel(new Point3D(31, 3, 4));
        test.putParcel(p1);
        test.putParcel(p2);
        test.putParcel(p3);
        test.putParcel(p4);
    ...
    public static final KnapsackGroup example = new KnapsackGroup(test, 20, new Point3D(100, 400, -100));
